...
export function Lobby() {
  ...
  const handleOpenRoom: MouseEventHandler<HTMLButtonElement> = (evt) => {
    ...
    if (routecHostSessionId && routecBoundRoomId && routecBoundRoomId === rId) {
      evt.currentTarget.setAttribute(
        'data-oysterun-routec-room-entry-state',
        'bound_room_row_clicked'
      );
      evt.currentTarget.setAttribute(
        'data-oysterun-clean-session-room-entry-state',
        'bound_room_row_clicked'
      );
      evt.currentTarget.setAttribute('data-oysterun-routec-room-entry-ready', 'true');
      evt.currentTarget.setAttribute('data-oysterun-clean-session-room-entry-ready', 'true');
    }

...
export function SystemNotification() {
  ...
  const nativeIOS = isOysterunCapacitorIOSRuntime();
  ...
  return (
    <Box direction="Column" gap="100">
      ...
      >
        <SettingTile
          title={nativeIOS ? 'iOS App Notifications' : 'Desktop Notifications'}
          description={
            nativeIOS ? (
              <span>
                Use iOS app notifications when provider replies complete. Manage permission in iOS
                Settings &gt; Notifications &gt; Oysterun.
              </span>
              ...
              <span>Show notifications when provider replies complete.</span>
            )
          }
          after={
            nativeIOS ? (
              <Switch value={showNotifications} onChange={setShowNotifications} />
      ...
      >
        <SettingTile
          ...
          description="Play sound when provider replies complete."

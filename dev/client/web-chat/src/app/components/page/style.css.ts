...
const iOSSafeAreaTop = 'env(safe-area-inset-top, 0px)';
const pageHeaderHeight = toRem(54);
const pageHeaderMinHeightWithSafeArea = `calc(${pageHeaderHeight} + ${iOSSafeAreaTop})`;
...
export const PageNavHeader = recipe({
  base: {
    minHeight: pageHeaderMinHeightWithSafeArea,
    padding: `${iOSSafeAreaTop} ${config.space.S200} 0 ${config.space.S300}`,
    flexShrink: 0,
    selectors: {
      'button&': {
        cursor: 'pointer',

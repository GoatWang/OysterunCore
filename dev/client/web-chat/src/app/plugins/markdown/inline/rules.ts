...
// TODO(P313): Keep this target allowlist in sync with RenderBody.tsx's
// markdown gate until Markdown link parsing uses one shared predicate.
const LINK_URL = `\\(((?:https?:\\/\\/|\\/sites\\/|\\/app\\/).+?)\\)`;

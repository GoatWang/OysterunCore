...
import { butterTheme, darkTheme, oysterunTheme, silverTheme } from '../../colors.css';
...
export const OysterunTheme: Theme = {
  id: 'oysterun-theme',
  kind: ThemeKind.Light,
  classNames: ['oysterun-theme', oysterunTheme, onLightFontWeight, 'prism-light'],
};
...
export const useThemes = (): Theme[] => {
  // P11 selects Oysterun through chat_theme for Route C; Settings should not expose a new selector.

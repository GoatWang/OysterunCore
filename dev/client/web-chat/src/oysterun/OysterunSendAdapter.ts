...
export function buildOysterunCorrelatedContent(content: IContent, roomId: string): IContent {
...
export async function sendOysterunMatrixMessage(
  ...
  const correlatedContent = buildOysterunCorrelatedContent(content, activeRoomId);

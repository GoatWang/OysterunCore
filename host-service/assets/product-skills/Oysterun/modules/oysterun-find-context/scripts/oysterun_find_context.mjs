...
const PRODUCT_MODULE = "chat";
const PRODUCT_ACTION = "messages-around";
...
const result = spawnSync(
  cli.command,
  [...cli.args, PRODUCT_MODULE, PRODUCT_ACTION, ...process.argv.slice(2)],
  {
    env: process.env,
    stdio: "inherit",
  }
...
if (result.error) {
  console.error(`oysterun find context: ${result.error.message}`);
  process.exit(1);
}
